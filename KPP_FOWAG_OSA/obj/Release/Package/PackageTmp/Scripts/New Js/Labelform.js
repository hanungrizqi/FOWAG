    ...
    function geteditLabelForm() {
        $.ajax({
            url: $("#web_link").val() + "/api/SampleDueDate/Get_SampleDueDate_ByID?wo=" + $("#IDWO").val() + '&dstrct=' + $("#District_HD").val() + '&compcode=' + $("#Comp_Code").val() + '&complbl=' + $("#Comp_Label").val(), //URI
            success: function (result) {
                ...
                if (result.Data.LabNumber == null) {
                    ...
                    if (newLabNo == null) {
                        $.ajax({
                            url: $("#web_link").val() + "/api/SampleDueDate/Cek_LastLabNumber?labnumber=" + newLabNo + '&wo=' + $("#IDWO").val() + '&dstrct=' + $("#District_HD").val() + '&compcode=' + $("#Comp_Code").val() + '&complbl=' + $("#Comp_Label").val(), //URI
                            success: function (data) {
                                ...
                                if (data == null) {
                                    ...
                                    debugger;
                                    var labno = newLabNo;
                                    var last1LabNo = newLabNo.substring(newLabNo.length - 1);
                                    var newLastNo = parseInt(last1LabNo) + 1;
                                    var ctxt = '' + newLastNo;
                                    var textNo = last1LabNo.substr(0, last1LabNo.length - ctxt.length) + ctxt;
                                    newLabNo = result.Data.DSTRCT + new Date().getFullYear() + textNo;
                ...
                //if (result.Data.ComponentJoin != null) {
                //    document.getElementById('txt_component').value = result.Data.ComponentJoin;
                //}
                ...
                //}
                //("#Comp_Code").val()
                document.getElementById('txt_component').value = $("#Comp_Code").val() + "-" + $("#Comp_Label").val();
